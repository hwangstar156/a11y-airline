...
const animateCarousel = (currentCarouselIndex) => {
    $carouselList.forEach((carousel) => {
        carousel.animate([{ transform: `translateX(calc((-270px) * ${currentCarouselIndex}))` }], {
            // timing options
            duration: 300,
            fill: "forwards",
        });
