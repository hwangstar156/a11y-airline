...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "li {\n  list-style: none;\n}\n\na {\n  appearance: none;\n  color: black;\n}\n\n* {\n  box-sizing: border-box;\n}\n\nbutton {\n  padding: 0;\n}\n\nul {\n  padding: 0;\n}\n\n.carousel-list {\n  display: flex;\n  gap: 10%;\n}\n\n.carousel-anchor {\n  display: block;\n  height: 100%;\n  width: 100%;\n}\n\n.carousel-image {\n  width: 100%;\n  height: 295px;\n}\n\n.arrow-button-list {\n  position: sticky;\n  width: 100%;\n  height: 60px;\n  bottom: calc((100% - 9rem) / 2);\n  left: 0;\n}\n\n.prev-arrow-button {\n  position: absolute;\n  left: 0;\n  background: url(\"https://www.koreanair.com/etc.clientlibs/koreanair/clientlibs/clientlib-base/resources/images/mris__button-left.svg\")\n    no-repeat left top;\n  background-size: 30px 60px;\n  width: 3rem;\n  height: 6rem;\n  transform: translateY(-50%);\n  border: 0;\n  cursor: pointer;\n}\n\n.next-arrow-button {\n  position: absolute;\n  right: 0;\n  background: url(\"https://www.koreanair.com/etc.clientlibs/koreanair/clientlibs/clientlib-base/resources/images/mris__button-right.svg\")\n    no-repeat right top;\n  background-size: 30px 60px;\n  width: 3rem;\n  height: 6rem;\n  transform: translateY(-50%);\n  border: 0;\n  cursor: pointer;\n}\n\n.carousel-container {\n  position: relative;\n  overflow: hidden;\n  width: 100vw;\n  max-width: 500px;\n}\n\n.carousel-description {\n  position: absolute;\n  top: 1.3rem;\n  left: 1.3rem;\n}\n\n.carousel-item {\n  position: relative;\n  width: 45%;\n  flex-shrink: 0;\n}\n\n.description-header {\n  font-size: 1.2rem;\n  margin-bottom: 0.8rem;\n  line-height: 1.5;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  word-wrap: break-word;\n  display: -webkit-box;\n  -webkit-line-clamp: 3;\n  -webkit-box-orient: vertical;\n  max-height: 7.2rem;\n}\n\n.description-class {\n  font-size: 1rem;\n  margin-bottom: 0.2rem;\n}\n\n.description-price {\n  font-size: 1rem;\n  font-weight: 700;\n  color: #11277b;\n}\n\n.sr-only {\n  position: absolute;\n  width: 1px;\n  height: 1px;\n  margin: -1px;\n  overflow: hidden;\n  clip-path: polygon(0 0, 0 0, 0 0);\n}\n", "",{"version":3,"sources":["webpack://./src/css/carousel.css"],"names":[],"mappings":"AAAA;EACE,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,YAAY;AACd;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,aAAa;EACb,QAAQ;AACV;;AAEA;EACE,cAAc;EACd,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,WAAW;EACX,aAAa;AACf;;AAEA;EACE,gBAAgB;EAChB,WAAW;EACX,YAAY;EACZ,+BAA+B;EAC/B,OAAO;AACT;;AAEA;EACE,kBAAkB;EAClB,OAAO;EACP;sBACoB;EACpB,0BAA0B;EAC1B,WAAW;EACX,YAAY;EACZ,2BAA2B;EAC3B,SAAS;EACT,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR;uBACqB;EACrB,0BAA0B;EAC1B,WAAW;EACX,YAAY;EACZ,2BAA2B;EAC3B,SAAS;EACT,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,gBAAgB;EAChB,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,UAAU;EACV,cAAc;AAChB;;AAEA;EACE,iBAAiB;EACjB,qBAAqB;EACrB,gBAAgB;EAChB,gBAAgB;EAChB,uBAAuB;EACvB,qBAAqB;EACrB,oBAAoB;EACpB,qBAAqB;EACrB,4BAA4B;EAC5B,kBAAkB;AACpB;;AAEA;EACE,eAAe;EACf,qBAAqB;AACvB;;AAEA;EACE,eAAe;EACf,gBAAgB;EAChB,cAAc;AAChB;;AAEA;EACE,kBAAkB;EAClB,UAAU;EACV,WAAW;EACX,YAAY;EACZ,gBAAgB;EAChB,iCAAiC;AACnC","sourcesContent":["li {\n  list-style: none;\n}\n\na {\n  appearance: none;\n  color: black;\n}\n\n* {\n  box-sizing: border-box;\n}\n\nbutton {\n  padding: 0;\n}\n\nul {\n  padding: 0;\n}\n\n.carousel-list {\n  display: flex;\n  gap: 10%;\n}\n\n.carousel-anchor {\n  display: block;\n  height: 100%;\n  width: 100%;\n}\n\n.carousel-image {\n  width: 100%;\n  height: 295px;\n}\n\n.arrow-button-list {\n  position: sticky;\n  width: 100%;\n  height: 60px;\n  bottom: calc((100% - 9rem) / 2);\n  left: 0;\n}\n\n.prev-arrow-button {\n  position: absolute;\n  left: 0;\n  background: url(\"https://www.koreanair.com/etc.clientlibs/koreanair/clientlibs/clientlib-base/resources/images/mris__button-left.svg\")\n    no-repeat left top;\n  background-size: 30px 60px;\n  width: 3rem;\n  height: 6rem;\n  transform: translateY(-50%);\n  border: 0;\n  cursor: pointer;\n}\n\n.next-arrow-button {\n  position: absolute;\n  right: 0;\n  background: url(\"https://www.koreanair.com/etc.clientlibs/koreanair/clientlibs/clientlib-base/resources/images/mris__button-right.svg\")\n    no-repeat right top;\n  background-size: 30px 60px;\n  width: 3rem;\n  height: 6rem;\n  transform: translateY(-50%);\n  border: 0;\n  cursor: pointer;\n}\n\n.carousel-container {\n  position: relative;\n  overflow: hidden;\n  width: 100vw;\n  max-width: 500px;\n}\n\n.carousel-description {\n  position: absolute;\n  top: 1.3rem;\n  left: 1.3rem;\n}\n\n.carousel-item {\n  position: relative;\n  width: 45%;\n  flex-shrink: 0;\n}\n\n.description-header {\n  font-size: 1.2rem;\n  margin-bottom: 0.8rem;\n  line-height: 1.5;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  word-wrap: break-word;\n  display: -webkit-box;\n  -webkit-line-clamp: 3;\n  -webkit-box-orient: vertical;\n  max-height: 7.2rem;\n}\n\n.description-class {\n  font-size: 1rem;\n  margin-bottom: 0.2rem;\n}\n\n.description-price {\n  font-size: 1rem;\n  font-weight: 700;\n  color: #11277b;\n}\n\n.sr-only {\n  position: absolute;\n  width: 1px;\n  height: 1px;\n  margin: -1px;\n  overflow: hidden;\n  clip-path: polygon(0 0, 0 0, 0 0);\n}\n"],"sourceRoot":""}]);
// Exports
...
const $prevArrowButton = document.querySelector(".prev-arrow-button");
const $nextArrowButton = document.querySelector(".next-arrow-button");
...
let prevId = 0;
const animateCarousel = (currentCarouselIndex) => {
    const carouselItemWidth = document.querySelector(".carousel-item").clientWidth;
    console.log(carouselItemWidth);
    $carouselList.forEach((carousel) => {
        carousel.animate([
            {
                transform: `translateX(calc((${-(carouselItemWidth * 1.23)}px) * ${currentCarouselIndex}))`,
            },
        ], {
            duration: 300,
            fill: "forwards",
...
$carouselAnchorList.forEach((carousel) => {
    carousel.addEventListener("focus", (e) => {
        var _a;
        const currentId = Number((_a = carousel.closest("li")) === null || _a === void 0 ? void 0 : _a.dataset.id);
        if (currentId === 0) {
            $srCarouselMessage === null || $srCarouselMessage === void 0 ? void 0 : $srCarouselMessage.insertAdjacentHTML("beforeend", "<p>첫번째 요소입니다!</p>");
        }
        if (currentId === 7) {
            $srCarouselMessage === null || $srCarouselMessage === void 0 ? void 0 : $srCarouselMessage.insertAdjacentHTML("beforeend", "<p>마지막 요소입니다.</p>");
        }
        if (prevId < currentId) {
            nextSlide();
        }
